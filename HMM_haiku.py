...
class HiddenMarkovModel:
    ...
    def generate_n_syllables(self, obs_map, obs_map_r, n_syllables, states):
        ...
        while (syllables.estimate(' '.join(words)) < n_syllables):
            ...
            if (syllables_estimate > n_syllables and syllables_estimate != n_syllables):
                # Undo last choice
                words = words[:-1]
    ...
    def generate_haiku(self, obs_map, obs_map_r):
        
        haiku = []
        states = []
        
        line1, states1 = self.generate_n_syllables(obs_map, obs_map_r, 5, states)
        line2, states2 = self.generate_n_syllables(obs_map, obs_map_r, 7, states1)
        line3, states3 = self.generate_n_syllables(obs_map, obs_map_r, 5, states2)
